...
export const ForumProvider = ({ children }) => {
  ...
  const votesHandler = (selectedPost, operation) => {
      ...
      return {
        ...
        posts: posts.reduce(
          (allPosts, currentPost) =>
            currentPost.postId === selectedPost.postId
              ? operation === 'inc'
                ? [
                    ...allPosts,
                ...
                : [
                    ...allPosts,
                    { ...currentPost, downvotes: currentPost.downvotes + 1 },
                  ]
              : [...allPosts, currentPost],
          []
        ),
  ...
  const getPostData = (postId) => {
    setCurrentPost(forumState.posts.find((post) => post.postId === postId));
  };
  return (
